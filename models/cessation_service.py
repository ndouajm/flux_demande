...
class CessationDeService(models.Model):
    ...
    _description = 'Cessation De Definitive De service'
    
    _inherit = ['mail.thread', 'mail.activity.mixin']
    
    name = fields.Char( default="Cessation Defiitive De Service", readonly=True)
    ...
    post_occuper = fields.Char(related="responsable_id.job_id.name", readonly=True)
